    ...
    <div>
      <div className='flex justify-between'>
        ...
        <div className="add_manager">
          <Button variant="contained" className='flex gap-2 items-center' onClick={() => navigate("/market/bills/create")} > <CreateNewFolderIcon /> <span>Tạo phiếu xuất</span> </Button>
        </div>
      </div>
...
export default ExportBillMarket