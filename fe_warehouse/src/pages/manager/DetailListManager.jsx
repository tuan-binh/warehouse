...
function DetailListManager() {
  ...
  const handleGoBack = () => {
    navigate(`/manager/reports/inventory`);
  }
  ...
  return (
    <div className='mx-20'>
      {console.log(data)}
      <div className="action py-2 flex justify-between">
            ...
            <Table sx={{ width: '100%' }} aria-label="simple table">
              <TableHead className='bg-slate-200'>
                <TableRow>
                  ...
                  <TableCell rowSpan={2} align="left">MÃ</TableCell>
                  <TableCell rowSpan={2} align="center">GIÁ THÀNH</TableCell>
                  <TableCell colSpan={2} align='center'>SỐ LƯỢNG</TableCell>
                  <TableCell rowSpan={2} align='center' sx={{ width: '400px' }}>LÝ DO</TableCell>
...
export default DetailListManager